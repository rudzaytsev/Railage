...
CREATE TABLE IF NOT EXISTS `railage`.`RouteParts` (
  `id` INT(11) NOT NULL COMMENT '',
  `routeId` INT(11) NULL COMMENT '',
  `stationId` INT(11) NULL COMMENT '',
  `nextRoutePartId` INT(11) NULL COMMENT '',
