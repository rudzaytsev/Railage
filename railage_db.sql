...
START TRANSACTION;
USE `railage`;
INSERT INTO `railage`.`Users` (`id`, `username`, `password`, `authority`) VALUES (1, 'admin', '$2a$10$EyAW.K4sV0W.9D28kDtzFesKnL32HuXFJsfBwXiW.Mdux9ADxXQKK', 'ROLE_EMPLOYEE');
INSERT INTO `railage`.`Users` (`id`, `username`, `password`, `authority`) VALUES (2, 'client', '$2a$10$6mD7u914rTB.1mBKiahA8OVE9PWIV3T1EpGhUl2RPTmeq3Cfv0kBK', 'ROLE_CLIENT');
