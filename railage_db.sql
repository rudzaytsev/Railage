...
START TRANSACTION;
USE `railage`;
INSERT INTO `railage`.`Users` (`id`, `username`, `password`, `authority`) VALUES (1, 'admin', 'admin', 'ROLE_EMPLOYEE');
INSERT INTO `railage`.`Users` (`id`, `username`, `password`, `authority`) VALUES (2, 'client', 'client', 'ROLE_CLIENT');
